...
public class DoctorAuthorizationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        button_sign_in.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    System.out.println("DoctorAuthorizationController: Connected to server.");
                } catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        button_create_an_account.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                SwitchScene.changeScene(actionEvent, "doctor-registration.fxml", "Doctor Registration Page", null);
            }
        });
