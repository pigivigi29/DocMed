...
public class DoctorRegistrationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        tf_specialization.setFocusTraversable(false);
        tf_experience.setFocusTraversable(false);
        ...
        button_sign_up.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent actionEvent) {
                ...
                try {
                    ...
                    System.out.println("DoctorRegistrationController: Connected to server.");
                } catch (IOException e) {
                    e.printStackTrace();
                }

                String action = "SIGN-UP-DOCTOR";
        ...
        button_sign_in.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                SwitchScene.changeScene(actionEvent, "doctor-authorization.fxml", "Doctor Authorization Page", null);
            }
        });
